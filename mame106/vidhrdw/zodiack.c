...
/* FRF FIX40: restored Zodiack bullet renderer */
static void zodiack_draw_bullets(mame_bitmap *bitmap)
{
	...
	{
		int x = zodiack_bulletsram[offs + 3] + 7;
		int y = 255 - zodiack_bulletsram[offs + 1];
...
/* FRF FIX40: restored Zodiack sprite renderer */
static void zodiack_draw_sprites(mame_bitmap *bitmap)
{
	...
	for (offs = spriteram_size - 4; offs >= 0; offs -= 4)
	{
		...
		int spritecode = spriteram[offs + 1] & 0x3f;
