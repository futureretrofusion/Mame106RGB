...
VIDEO_EOF( exidy )
{
	...
	struct drawgfxParams dgp1={
		motion_object_1_vid, Machine->gfx[1], 0, 0, 0, 0, 0, 0,
		&clip, TRANSPARENCY_NONE, 0, 0, 0, NULL, 0
	};
	struct drawgfxParams dgp2={
		motion_object_2_vid, Machine->gfx[1], 0, 0, 0, 0, 0, 0,
		&clip, TRANSPARENCY_NONE, 0, 0, 0, NULL, 0
	};
	struct drawgfxParams dgp3={
		motion_object_2_clip, Machine->gfx[1], 0, 0, 0, 0, 0, 0,
		&clip, TRANSPARENCY_NONE, 0, 0, 0, NULL, 0
	};
