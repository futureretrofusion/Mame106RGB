...
/* FRF_BURGERTIME_ONLY_DRIVER_LIST_V1 */
#if defined(LINK_BURGERTIME) && !defined(LINK_DATAEAST)
    DRIVER( btime )
    DRIVER( btime2 )
    DRIVER( btimem )
#endif

/* FRF_JAILBREK_REGISTRY_V1_BEGIN */
/* FRF_TIMEPILOT_SPACEPILOT_REGISTRY_V11_BEGIN */
#ifdef LINK_TIMEPILOT
    DRIVER( timeplt )  /* Time Pilot */
    DRIVER( timepltc ) /* Time Pilot (Centuri) */
    DRIVER( timeplta ) /* Time Pilot (Atari) */
    DRIVER( spaceplt ) /* Space Pilot */
#endif
/* FRF_TIMEPILOT_SPACEPILOT_REGISTRY_V11_END */

#ifdef LINK_JAILBREK
    DRIVER( jailbrek ) /* 1986 Konami - Jail Break */
    DRIVER( manhatan ) /* 1986 Konami - Manhattan 24 Bunsyo */
#endif
/* FRF_JAILBREK_REGISTRY_V1_END */
	...
	DRIVER( moguchan ) /* 1982 "Orca (Eastern Commerce Inc. license) (bootleg?)" "Moguchan" */
...
#endif
#ifdef LINK_SETA
	/* FRF FIX62: removed invalid generated DRIVER(NAME) registry entry */
